 ...
 * Generated at: 2021-04-11 08:35:23 UTC
...
public final class noticeDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null){ 
      ...
      out.write("</textarea> \r\n");
      out.write("\t\t\t\t\t\t\t<!-- 길지만 이렇게 넣어주는게 공백 방지됨 -->\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t\r\n");
 ...
 if(loginUser != null && loginUser.getUserId().equals(notice.getNoticeWriter())){ 
      ...
      out.write("\t\t\t\t\t\t<input type=\"button\" id=\"deleteNoBtn\" value=\"삭제\">\r\n");
      out.write("\t\t\t\t\t");
 } 
      out.write("\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<script>\r\n");
      out.write("\t\t$('#deleteNoBtn').on('click', function(){\r\n");
